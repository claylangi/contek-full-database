...
if(isset ($_POST ['update']))
{
    ...
    // update user data
    $result = mysqli_query($conn, "UPDATE teaches
    SET course_id='$course_id' ,sec_id='$sec_id' ,semester='$semester',year='$year' WHERE ID='$ID'");
...
$result = mysqli_query($conn, "SELECT * FROM teaches WHERE ID='$ID'");
